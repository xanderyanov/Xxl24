    ...
    public static class Data
    {
        ...
        public static void ImportCSV(string filename)
        {
            ...
            while (csv.Next()) {
                ...
                // mod |= tovar.Set(x => x.FO_Balance, Int32.Parse(csv["FO_Balance"]));
